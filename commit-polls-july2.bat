...
set "LOG=%~dp0commit-polls-july2-log.txt"

echo. > "%LOG%"
echo === commit-polls-july2.bat === >> "%LOG%"
...
"%GIT_EXE%" commit -m "Poll update July 2: ME senate Quantus+Fox, ME gov NYT/Siena, NC/OH/IA NYT/Siena, IA Fox" >> "%LOG%" 2>&1
